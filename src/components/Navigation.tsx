...
const Navigation = () => {
    ...
    const projects = [
        { name: "Virtual Reality", color: "indigo" },
        { name: "Apple Vision Pro", color: "cyan" },
        { name: "Porsche", color: "pink" },
    ];
            ...
            >
                ...
                <div className="flex flex-col gap-3">
                    {projects.map((project, index) => (
                        ...
                        >
                            <div
                                className={`min-w-4 mx-2 border-${project.color}-600 border rounded-full aspect-square bg-${project.color}-100`}
                            />
                        </ProjectLink>
                    ))}

                    {projects.length > 3 && ( // Only render if there are more than 3 projects
                        <ProjectLink
                            name="See More . . ."
                            setSelectedProject={setSelectedProject}
                        />
